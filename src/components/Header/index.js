                    ...
                    <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
                      <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                        ...
                        <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                          ...
                          <a href="#" class="font-medium text-gray-500 hover:text-gray-900">Serviços</a>

                          <a href="#" class="font-medium text-gray-500 hover:text-gray-900">Galeria</a>

                          <a href="#" class="font-medium text-gray-500 hover:text-gray-900">Conato</a>
                        </div>
                      </nav>
                    </div>
                  ...
                  <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                      <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                        ...
                        <span class="block text-indigo-600 xl:inline banner-title"> consectetur adipiscing elit.</span>
                      </h1>
